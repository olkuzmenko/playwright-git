...
randomeStr();
   ...
   test.describe('redmine testcases', () =>{
    ...
    test('use repository page', async ({ page }) => {
    ...
    test('Open page with users of Redmine', async ({ page }) =>{
    ...
    test('Register new user', async ({ page }) =>{
      ...
      // add randomizers to login email f-name l-name
    ...
    test('take a look to quastion page', async ({ page }) =>{
      ...
      //await checkedFilter.check();
      //await expect(checkedFilter).isChecked();
